ActiveAdmin.register Page do
  ...
  form do |f|
    f.inputs do
      ...
      f.input :slug, hint: 'This is the FULL path of the page after our root domain, and it has nothing to do with parent/child pages. E.g. if you want a page to live at "sacdsa.org/about/mission", put "about/mission" here. At least one Page should have the slug "home".'
    ...
    f.inputs 'Sign Up' do
      ...
      f.input :form_tags, hint: 'Comma-separated list of NationBuilder tags to add when someone signs up (e.g. "newsletter" to sign them up for our newsletter). At least 1 is required.'
    end
    f.actions
  end
